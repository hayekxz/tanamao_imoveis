<div class="card card-info card-outline mb-4">
    ...
    <form class="needs-validation" method="POST" action="<?= URL_BASE ?>imovel/adicionar" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    ...
                    <div style="font-weight: 650;" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nome_imovel" class="form-control" id="nome_imovel" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="endereco_imovel" class="form-control" id="endereco_imovel" required>
                        </div>
                        <div class="col-md-4">
                            <label for="tipo_imovel" class="form-label">Tipo do imovel</label>
                            <select name="id_tipo_imovel" id="id_tipo_imovel" class="form-select" required>
                                <option selected>Selecione o tipo</option>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="bairro_imovel" class="form-control" id="bairro_imovel" required>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="cep_imovel" class="form-control" id="cep_imovel" required>
                        </div>
                        <div class="col-md-4">
                            <label for="complemento_imovel" class="form-label">Complemento</label>
                            <input type="text" name="complemento_imovel" class="form-control" id="complemento_imovel" required step="0.01" min="100">
                        </div>
                        <div class="col-md-4">
                            <label for="estado_imovel" class="form-label">Estado</label>
                            <input type="text" name="estado_imovel" class="form-control" id="estado_imovel" required step="0.01" min="100">
                        </div>
                        <div class="col-md-8">
                            <label for="descricao_imovel" class="form-label">Descrição</label>
                            <textarea name="descricao_imovel" class="form-control" id="descricao_imovel" required></textarea>
                        </div>
                        <div class="col-md-4">
                            <label for="valor_imovel" class="form-label">Valor: </label>
                            <input type="number" name="preco_imovel" class="form-control" required step="0.01" min="100">
                        </div>
                    </div>
